...
export function FeatureInfoAnnouncement() {
  useEffect(() => {
    ...
    try {
      ...
      const t = setTimeout(() => {
        toast.info(
          'New: tap the small (i) icon in the bottom-right of any page for a full guide to how that feature works. Every feature on Mitype now has one. Explore Discover, Wave, The Current, Messages, Brand Deals, Collab Board, Meetups, Project Rooms, Small Businesses, Mi Home Goods, and more.',
          { duration: 15000 }
        );
